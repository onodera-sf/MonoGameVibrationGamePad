...
namespace VibrationGamePad
{
    ...
    protected override void Update(GameTime gameTime)
    {
      ...
      GamePad.SetVibration(PlayerIndex.One,
          _gamePadState.Triggers.Left, _gamePadState.Triggers.Right);
    ...
    protected override void Draw(GameTime gameTime)
    {
      ...
      _spriteBatch.DrawString(_font,
          "LeftTrigger  : " + _gamePadState.Triggers.Left.ToString("f8"),
          new Vector2(20.0f, 30.0f), Color.White);

      // 右トリガー
      _spriteBatch.DrawString(_font,
          "RIghtTrigger : " + _gamePadState.Triggers.Right.ToString("f8"),
